package me.proj.soccernews.data;

import androidx.room.Room;

import me.proj.soccernews.App;
import me.proj.soccernews.data.local.SoccerNewsDb;
import me.proj.soccernews.data.remote.SoccerNewsApi;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://RubaTeixeira.github.io/soccer-news-api/";
